...
public class CashReg
{
   ...
   */
   public void recordPurchase(int amount)
   {
   ...
   */
   public void enterPayment(int cents, double dollars, double quarters, 
         double dimes, double nickels, double pennies)
   {
      payment = ((int) (cents + dollars*DOLLAR_VALUE + quarters * QUARTER_VALUE + dimes * DIME_VALUE
